...
namespace UnitTest {
    ...
    public class UnitTestAccount {
                ...
                Dictionary<string, string> resource_info = new Dictionary<string, string>
            {
                ...
                Assert.AreEqual(SuperAccount.Error.RES_UNEXISTED, admin.UpdateResource(ref resource_info));
                Dictionary<string, string> resource_info2 = new Dictionary<string, string>
            {
                { "resourceID" , null },
                {  "positionX"  , "50" },
                ...
                Assert.AreEqual(SuperAccount.Error.PARAM_FORMAT_ERROR, admin.UpdateResource(ref resource_info2));
                Dictionary<string, string> resource_info3 = new Dictionary<string, string>
            {
                ...
                Assert.AreEqual(SuperAccount.Error.OK, admin.UpdateResource(ref resource_info3));
